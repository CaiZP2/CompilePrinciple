...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MUL = 6,                        /* MUL  */
  YYSYMBOL_DIV = 7,                        /* DIV  */
  YYSYMBOL_LEFTSM = 8,                     /* LEFTSM  */
  YYSYMBOL_RIGHTSM = 9,                    /* RIGHTSM  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ASSIGN", "ADD",
  "MINUS", "MUL", "DIV", "LEFTSM", "RIGHTSM", "NUMBER", "ID", "MOD",
  "UMINUS", "';'", "$accept", "lines", "stmt", "expr", YY_NULLPTR
};
...
{
     -11,    11,   -11,    -2,    -2,   -11,    -1,   -11,   -10,    22,
     -11,   -11,    26,    -2,   -11,    -2,    -2,    -2,    -2,   -11,
     -11,    33,    17,    17,   -11,   -11
};
...
{
      11,    12,    13,     3,    14,     0,     4,     0,     5,    10,
      21,     2,    22,    23,    24,    25,     3,     0,     0,     4,
       0,     5,     6,    17,    18,     7,    15,    16,    17,    18,
      15,    16,    17,    18,     0,    20,    19,    15,    16,    17,
      18
};

static const yytype_int8 yycheck[] =
{
       3,     4,     3,     5,    14,    -1,     8,    -1,    10,    11,
      13,     0,    15,    16,    17,    18,     5,    -1,    -1,     8,
      -1,    10,    11,     6,     7,    14,     4,     5,     6,     7,
       4,     5,     6,     7,    -1,     9,    14,     4,     5,     6,
       7
};
...
{
       0,    16,     0,     5,     8,    10,    11,    14,    17,    18,
      11,    18,    18,     3,    14,     4,     5,     6,     7,    14,
       9,    18,    18,    18,    18,    18
};
...
#line 1190 "yThree.tab.c"
    break;

  case 8: /* expr: expr MINUS expr  */
#line 57 "yaccThree.y"
                                  { (yyval.dbl)=(yyvsp[-2].dbl)-(yyvsp[0].dbl); }
#line 1196 "yThree.tab.c"
    break;

  case 9: /* expr: expr MUL expr  */
#line 58 "yaccThree.y"
                                {(yyval.dbl)=(yyvsp[-2].dbl)*(yyvsp[0].dbl);}
#line 1202 "yThree.tab.c"
    break;

  case 10: /* expr: expr DIV expr  */
#line 59 "yaccThree.y"
                                {(yyval.dbl)=(yyvsp[-2].dbl)/(yyvsp[0].dbl);}
#line 1208 "yThree.tab.c"
    break;

  case 11: /* expr: LEFTSM expr RIGHTSM  */
#line 60 "yaccThree.y"
                                    {(yyval.dbl)=(yyvsp[-1].dbl);}
#line 1214 "yThree.tab.c"
    break;

  case 12: /* expr: MINUS expr  */
#line 61 "yaccThree.y"
                                          {(yyval.dbl)=-(yyvsp[0].dbl);}
#line 1220 "yThree.tab.c"
    break;

  case 13: /* expr: NUMBER  */
#line 62 "yaccThree.y"
                        {(yyval.dbl)=strToNumber((yyvsp[0].str));}
#line 1226 "yThree.tab.c"
    break;

  case 14: /* expr: ID  */
#line 63 "yaccThree.y"
                      {auto iter=symFind((yyvsp[0].str));if(iter!=symTab.end()){(yyval.dbl)=symTab[iter->first];}else{symTab[(yyvsp[0].str)]=0;(yyval.dbl)=symTab[(yyvsp[0].str)];}}
#line 1232 "yThree.tab.c"
    break;


#line 1236 "yThree.tab.c"
